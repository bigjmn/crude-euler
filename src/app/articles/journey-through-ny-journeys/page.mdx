...
export const article = {
  ...
  description:
    "I've been exploring some math problems inspired by travel in New York City. The problems themselves are quite unrelated, but so few of these posts will have a common thread that I figure I should lean in when there's any connection."
}
...
<figure>
<Image src={loopsNy} alt="" />
<figcaption style={{justifySelf:'center'}}>Any direct path must be faster than all indirect paths</figcaption>
</figure>

Note: that rule is essentially the triangle inequality theorem - not as it applies to actual triangles in Euclidean space (since we don’t require edges to be straight or anything) but the measure theory version, which refers to generalized distances in a metric space.
...
Does there exist a planar ENYV for N >= 5?

If you can figure out either of these, let me know. And hit me up if you’re in NYC - I can be there in either 20 or 45 minutes. 
